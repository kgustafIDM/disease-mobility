...
%       s.XMLname.Comment{1}.Text= 'some text';
%       s.XMLname.Comment{2}.Text= 'other text';
%
%   will produce:
%       <!-- some text -->
%       <!-- other text -->
...
% ability to add top-level comment field added by M. Famulare, 25-10-2012
...
% ----- Subfunction formatComment -----
function formatComment(file)
