...
% here, nL3id contains each chiefdom in the annotated district, or a single
% chiefdom if it is annotated. Thus the loop will automatically determine
% multiple possible chiefdom connections and propogate these through the
% driving distance (EVDroadist) and population pairs (EVDpop)
